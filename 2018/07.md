...
1. Short (&le;30m) Timeboxed Discussions
    ...
    | timebox | topic | presenter |
    |:-------:|-------|-----------|
    | 15m     | New name for [`global`](https://github.com/tc39/proposal-global/issues/20) | Jordan Harband |
    | 15m     | Introducing [Ecma TC53](https://www.ecma.ch/memento/TC53.htm) - Smart wearable systems and sensor-based devices | Peter Hoddie |
